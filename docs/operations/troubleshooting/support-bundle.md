...
For **which diagnostics live in the bundle vs other APIs** (migration integrity, scheduler, stale snapshots), see `docs/operations/troubleshooting/support-diagnostics.md`.
