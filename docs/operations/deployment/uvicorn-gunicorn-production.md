...
This document complements `docs/operations/deployment/https-reverse-proxy.md`, `docs/operations/deployment/docker-platform.md`, and `docs/operations/deployment/install-guide.md`. The API is a **FastAPI (ASGI)** application (`app.main:app`).
...
Nginx variables of interest are documented in `docs/operations/deployment/https-reverse-proxy.md` and `docker/reverse-proxy/nginx.conf`.
...
- Operational retention: `docs/operations/data-management/retention-policies.md`.
