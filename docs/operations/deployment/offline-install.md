...
Operator validation checklist: `docs/operations/deployment/offline-install-validation.md` (also copied into the offline package under `docs/`).
...
- `docs/operations/deployment/install-guide.md` — online install (`scripts/release/install.sh`)
- `docs/operations/deployment/upgrade-guide.md` — in-place upgrade with backup
