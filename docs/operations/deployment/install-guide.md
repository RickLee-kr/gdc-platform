...
This guide covers installing the platform on a **clean Ubuntu 24.04** server using Docker Compose and `scripts/release/install.sh`. It complements `docs/operations/deployment/https-reverse-proxy.md` and `docs/operations/operator-runbook.md`.
...
See `docs/operations/data-management/backup-restore.md` before major changes.
...
- Upgrades: `docs/operations/deployment/upgrade-guide.md`
- Backups: `docs/operations/data-management/backup-restore.md`
- Release verification: `docs/operations/deployment/release-checklist.md`
