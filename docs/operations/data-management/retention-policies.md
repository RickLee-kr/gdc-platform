...
The platform does **not** ship automatic archival to S3; wire your organisation’s backup pipeline (`docs/operations/data-management/backup-restore.md`, `docs/operations/data-management/backup-restore.md`).
...
- `docs/operations/deployment/uvicorn-gunicorn-production.md` — pool sizing vs retention batch load
