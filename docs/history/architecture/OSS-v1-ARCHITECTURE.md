> **HISTORICAL — folded (Phase 3)**
> Architecture explanation authority is `docs/canonical/02-SYSTEM-ARCHITECTURE.md` (+ domain canonical docs).
> Compatibility pointer: `docs/architecture/OSS-v1-ARCHITECTURE.md`.
> Detailed contracts: `docs/reference/` and `specs/*`.

# Data Relay OSS v1 — Architecture Overview

**Audience:** Operators, integrators, and contributors  
**Authority (historical):** superseded by `docs/canonical/`; see pointer at `docs/architecture/OSS-v1-ARCHITECTURE.md`  
...
| Document | Topic |
|----------|-------|
| [Source of Truth Index](../../architecture/source-of-truth-index.md) | Reading order and classification |
