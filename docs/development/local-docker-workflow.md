...
Details, HTTPS, and smoke script: **`docs/operations/deployment/docker-platform.md`**.
...
- `docs/operations/deployment/docker-platform.md` — HTTPS proxy stack, admin seed
- `docs/testing/dev-validation-lab.md` — lab commands, configuration, production separation
- `docs/operations/operator-runbook.md` — host uvicorn + Vite (non-Docker) notes
