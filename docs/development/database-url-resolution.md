...
- [../history/performance/runtime-snapshot-read-model-phase-4.md](../history/performance/runtime-snapshot-read-model-phase-4.md) — Phase 4 migration `20260522_0024_rt_ops_snap`
